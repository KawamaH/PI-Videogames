          ...
          return (
            <Card
              ...
              image={
                videogame.image
                  ? videogame.image
                  : "https://img.freepik.com/premium-vector/pixel-art-joystick-video-game-old-vector-icon-8bit-game-white-background_360488-483.jpg"
              }
              genre={
                !videogame.createinDb
                  ? videogame.genres.join(', ')
                  : videogame.Genres.map((v) => v.name).join(', ')
              }
            />
          );
        })}
